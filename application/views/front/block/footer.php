    ...
    <div class="footer-middle container">
        <div class="col-md-3 col-sm-4">
            ...
            <div class="payment-accept">
                <div><img src="<?php echo public_url('front');?>/digital_template/images/payment-1.png" alt="payment"> <img src="<?php echo public_url('front');?>/digital_template/images/payment-2.png" alt="payment"> <img src="<?php echo public_url('front');?>/digital_template/images/payment-3.png" alt="payment"> <img src="<?php echo public_url('front');?>/digital_template/images/payment-4.png" alt="payment"></div>
            </div>
        </div>
...
<!-- JavaScript -->
<script type="text/javascript" src="<?php echo public_url('front');?>/digital_template/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('front');?>/digital_template/js/bootstrap.min.js"></script>

<script type="text/javascript" src="<?php echo public_url('front');?>/digital_template/js/common.js"></script>
<script type="text/javascript" src="<?php echo public_url('front');?>/digital_template/js/revslider.js"></script>
<script type="text/javascript" src="<?php echo public_url('front');?>/digital_template/js/owl.carousel.min.js"></script>
