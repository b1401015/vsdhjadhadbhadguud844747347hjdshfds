<div class="page">
        ...
        <div class="header-top">
            <div class="container">
                <div class="row">
                    <!-- Header Language -->
                    <div class="col-xs-6">
                        <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="<?php echo public_url('front');?>/digital_template/images/english.png" alt="language"> English <span class="caret"></span> </a>
                            <ul class="dropdown-menu" role="menu">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?php echo public_url('front');?>/digital_template/images/english.png" alt="language"> English </a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?php echo public_url('front');?>/digital_template/images/francais.png" alt="language"> French </a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img src="<?php echo public_url('front');?>/digital_template/images/german.png" alt="language"> German </a></li>
                            </ul>
                        </div>
                        <!-- End Header Language -->
                        <!-- Header Currency -->
        ...
        <div class="header container">
            <div class="row">
                <div class="col-lg-2 col-sm-3 col-md-2 col-xs-12">
                    <!-- Header Logo -->
                    <a class="logo" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="<?php echo public_url('front');?>/digital_template/images/logo.png"></a>
                    <!-- End Header Logo -->
                </div>
                <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12">
                    ...
                    <div class="search-box">
                        <form action="http://htmldemo.magikcommerce.com/ecommerce/inspire-html-template/digital/cat" method="POST" id="search_mini_form" name="Categories">
                            ...
                            <input style="border: 1px solid #ddd;" type="text" placeholder="Search here..." value="" maxlength="100" class="" name="search" id="search">
                            ...
                            <div>
                                <div class="top-cart-content arrow_box">
                                    ...
                                    <ul id="cart-sidebar" class="mini-products-list">
                                        <li class="item even"> <a class="product-image" href="#" title="Downloadable Product "><img alt="Downloadable Product " src="<?php echo public_url('front');?>/digital_template/products-images/product1.jpg" width="80"></a>
                                        ...
                                        <li class="item last odd"> <a class="product-image" href="#" title="  Sample Product "><img alt="  Sample Product " src="<?php echo public_url('front');?>/digital_template/products-images/product11.jpg" width="80"></a>
                                            <div class="detail-item">
                                                <div class="product-details"> <a href="#" title="Remove This Item" onClick="" class="glyphicon glyphicon-remove">&nbsp;</a> <a class="glyphicon glyphicon-pencil" title="Edit item" href="#">&nbsp;</a>
    ...
    <!-- end header -->
    <!-- Navbar -->
    <nav style="background-color: #d0ba65;">
        <div class="container">
            <div class="nav-inner">
                ...
                <!--End mobile-menu -->
                <a class="logo-small" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="<?php echo public_url('front');?>/digital_template/images/logo-small.png"></a>
                        ...
                        <div class="level0-wrapper dropdown-6col" style="display:none;">
                            <div class="level0-wrapper2">
                                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col">
                                    ...
                                    <div class="nav-add">
                                        <div class="push_item1">
                                            <div class="push_img"> <a href="#"> <img  alt="women jwellery" src="<?php echo public_url('front');?>/digital_template/images/women-cate-banner.jpg"> </a> </div>
                                        </div>
                                        <div class="push_item1">
                                            <div class="push_img"> <a href="#"> <img  alt="women_jwellery" src="<?php echo public_url('front');?>/digital_template/images/women-cate-banner1.jpg"> </a> </div>
                                        </div>
                                        <div class="push_item1 push_item1_last">
                                            <div class="push_img"> <a href="#"> <img  alt="women_bag" src="<?php echo public_url('front');?>/digital_template/images/women-cate-banner2.jpg"> </a> </div>
                                        </div>
                                        <br class="clear">
                                    </div>
                                </div>
                                ...
                                <div class="nav-block nav-block-right std grid12-4">
                                    <p><a href="#"><img class="fade-on-hover" src="<?php echo public_url('front');?>/digital_template/images/nav-women-banner.jpg" alt="nav img"></a></p>
                                </div>
                        ...
                        <div class="level0-wrapper dropdown-6col" style="display: none;">
                            <div class="level0-wrapper2">
                                ...
                                <div class="nav-block nav-block-left std grid12-6">
                                    <p><a href="#"><img class="fade-on-hover" src="<?php echo public_url('front');?>/digital_template/images/nav-men-banner.jpg" alt="nav img"></a></p>
                                </div>
                                <!--nav-block nav-block-right std grid12-4-->
                                ...
                                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col">
                                    ...
                                    <div class="nav-add">
                                        <div class="push_item">
                                            <div class="push_img"> <a href="#"> <img  alt="women_jwellery" src="<?php echo public_url('front');?>/digital_template/images/men-banner-img.jpg"> </a> </div>
                                        </div>
                                        <div class="push_item last">
                                            <div class="push_img"> <a href="#"> <img  alt="women_jwellery" src="<?php echo public_url('front');?>/digital_template/images/men-banner-img1.jpg"> </a> </div>
                                        </div>
                                        <br class="clear">
                                    </div>
                                </div>
                    ...
                    <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>Electronics</span> </a>
                        <div style="display:none;" class="level0-wrapper dropdown-6col">
                            <div class="level0-wrapper2">
                                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col">
                                    ...
                                    <ul class="level3">
                                        <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Mobiles</span></a>
                                            ...
                                            <!--sub sub category-->
                                            <div class="cat-img"><img src="<?php echo public_url('front');?>/digital_template/images/e-img1.jpg" alt="Mobiles"></div>
                                        </li>
                                        ...
                                        <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Mobiles Accesories</span></a>
                                            ...
                                            <!--sub sub category-->
                                            <div class="cat-img"><img src="<?php echo public_url('front');?>/digital_template/images/e-img2.jpg" alt="Mobiles Accesories"></div>
                                        </li>
                                        <!--level1 nav-6-1 parent item-->
                                        ...
                                        <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Cameras</span></a>
                                            ...
                                            <!--sub sub category-->
                                            <div class="cat-img"><img src="<?php echo public_url('front');?>/digital_template/images/e-img3.jpg" alt="Cameras"></div>
                                        </li>
                                        <!--level1 nav-6-1 parent item-->
                                        ...
                                        <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Audio &amp; Video</span></a>
                                            ...
                                            <!--level1-->
                                            <!--sub sub category-->
                                            <div class="cat-img"><img src="<?php echo public_url('front');?>/digital_template/images/e-img4.jpg" alt="Audio &amp; Video"></div>
                                        </li>
                                        <!--level1 nav-6-1 parent item-->
                                    </ul>
                                    <!--level0-->
                                ...
                                <!--nav-block nav-block-center-->
                                <div class="nav-block nav-block-right std grid12-4">
                                    <p><a href="#"><img class="fade-on-hover" src="<?php echo public_url('front');?>/digital_template/images/nav-img1.jpg" alt="nav img"></a></p>
