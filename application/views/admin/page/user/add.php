                                    ...
                                    <div class="tab-content">
                                        <div id="login" class="tab-pane fade in active">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-5">
                                                    <input class="form-control trim_value" id="username" name="username" type="text" value="" required />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <label for="title" class="control-label col-lg-2">Email<span class="required">*</span></label>
                                                <div class="col-lg-5">
                                        ...
                                        <div id="info" class="tab-pane">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-5">
                                                    <input class="form-control" id="phone_" name="phone" onKeyPress="return isNumberKey(event)" type="text" />
                                                </div>
                                            </div>
                                            <div class="form-group ">
