...
if ($("#example1").length) {
    var table = $('#example1').DataTable({
        ...
        "lengthChange": false,
        "ajax": {
            url : CONSTANT.API.GET_BANNER_LIST,
            type : "post",
            data: {}
        },
        "columns": [
            ...
            { "data": "update_time" },
            {
                "data": null,
                "render": function (data, type, row, meta) {
                    return '<div class="btn-group"><a href="'+ baseURL +'_admin/banner/edit_banner/' + row._id + '" class="btn btn-success"><i class="fa fa-fw fa-pencil-square-o"></i></a><a href="javascript:void(0)" class="btn btn-danger delete-item"><i class="fa fa-fw fa-trash-o"></i></a></div>';
                }
            },
        ], //end columns
    ...
    $('#example1 tbody').on('change', '.is-active-item', function () {
        ...
        var $url = '/_api/admin/banner/banner_toggle_is_active/' + $id;
    ...
    $('#example1 tbody').on('click', '.delete-item', function () {
        ...
        var $url = '/_api/admin/banner/delete_banner/' + $id;
